package org.hands_on_digits.havahsadventure.world.features;
...
import org.hands_on_digits.havahsadventure.world.features.configurations.StructureFeatureConfiguration;
...
public class StructureFeature extends Feature<StructureFeatureConfiguration> {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(Registries.FEATURE, HavahsAdventureMod.MODID);
