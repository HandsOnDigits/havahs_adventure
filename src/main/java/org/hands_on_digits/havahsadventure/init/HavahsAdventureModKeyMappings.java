...
import org.hands_on_digits.havahsadventure.network.PegasusFlyUpMessage;

@EventBusSubscriber(Dist.CLIENT)
public class HavahsAdventureModKeyMappings {
	public static final KeyMapping PEGASUS_FLY_UP = new KeyMapping("key.havahs_adventure.pegasus_fly_up", GLFW.GLFW_KEY_SPACE, "key.category.havahs_adventure.movement") {
